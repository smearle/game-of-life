...
def make_env(env_id, seed, rank, log_dir, add_timestep, allow_early_resets, map_width=20, render_gui=False, print_map=False, parallel_py2gui=False, noreward=False, max_step=None, simple_reward=False, args=None, device=None):
    def _thunk():
...
def make_vec_envs(env_name, seed, num_processes, gamma, log_dir, add_timestep,
    ...
    envs = [make_env(env_name, seed, i, log_dir, add_timestep, 
        ...
        print_map=args.print_map, noreward=args.no_reward, max_step=args.max_step, simple_reward=args.simple_reward, args=args, device=device)
